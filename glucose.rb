class Glucose < Formula
  desc "SAT Solver with parallel abilities based on Minisat"
  ...
  bottle do
    ...
    rebuild 1
    sha256 cellar: :any_skip_relocation, high_sierra: "ea7764c05f501b879a843420175d2ac8c767504c1892ba1d48c981e2c40b5a04"
    sha256 cellar: :any_skip_relocation, sierra: "ea7764c05f501b879a843420175d2ac8c767504c1892ba1d48c981e2c40b5a04"
    sha256 cellar: :any_skip_relocation, el_capitan: "9a80d9f899f0dc38768e78a7b10de28dfcfcdddf8b5460f1cabcbe4d2c93a936"
    sha256 cellar: :any_skip_relocation, x86_64_linux: "6a35552576991d1387c30d155d5eb4102a3a12b24e943a55574aeb75f38ba4c2"
  end
